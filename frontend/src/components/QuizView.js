...
const formatGuess = (guess = '') =>
  guess.replace(/[.,\/#!$%\^&\*;:{}=\-_`~()]/g, '').toLowerCase(); // eslint-disable-line
...
class QuizView extends Component {
  ...
  submitGuess = (event) => {
    ...
    // const formattedGuess = formatGuess(this.state.guess)
  ...
  evaluateAnswer = () => {
    ...
    const answerArray = this.state.currentQuestion.answer
      .toLowerCase()
      .split(' ');
    return answerArray.every((el) => formattedGuess.includes(el));
  };
